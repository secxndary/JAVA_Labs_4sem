...
{
    private List<Taxi> taxiList = new ArrayList<>();    /// list в котором хранятся все такси в парке
    ...
    public class Manager implements IManager    /// вложенный класс, наследуемый от интерфейса
    {
