...
public class Child extends Taxi
{
    private final carType type = carType.child;
    private double taxiFare = 1.5;

    public Child() {}

    public Child(String name, double fuel, int speed) throws TaxiException {
    ...
    public double ride(double km) throws TaxiException {
        ...
        System.out.println("Вы проехали " + km + " км в " + getName() + " (Детский). С Вас " + priceForRide + " р. Спасибо за поездку!");
        return getProfit();
    }
}
